...
4. Clone the repo using the below command
 > git clone  https://github.com/Microverse-Fullstack-Program/Awesome-Books.git
...
Feel free to check the [issues page](https://github.com/Microverse-Fullstack-Program/Awesome-Books/issues).
